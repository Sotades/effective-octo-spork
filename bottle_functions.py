# This file includes all the functions that are needed for the bottle quality inspection.
# It is split to 3 stages: 1) Framegrabbing 2)Pre-processing 3)Quality inspection
